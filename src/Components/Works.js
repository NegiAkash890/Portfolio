    ...
    <div className="work_container" id='works'>
      ...
      <div className="project_works">
        <a className='project_container'  href='https://walmat-clone.web.app/'>
          ...
          <img src={process.env.PUBLIC_URL+'/WMC.png'} className='thumbnail'/>
        </a>
         ...
         <img src={process.env.PUBLIC_URL+'/NFX.png'} className='thumbnail'/>
        </a>
         ...
         <img src={process.env.PUBLIC_URL+'/RQM.png'} className='thumbnail'/>
        </a>
      </div>
    </div>
  );
